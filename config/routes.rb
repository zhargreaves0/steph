Steph::Application.routes.draw do
  ...
  match '/TESTAPI/resetFixture' => 'users#TESTAPI_resetFixture', :via => :post, :defaults => { :format => 'json' }
  match '/TESTAPI/unitTests' => 'users#TESTAPI_unitTests', :via => :post, :defaults => { :format => 'json' }
